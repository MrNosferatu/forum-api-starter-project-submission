...
class CommentRepositoryPostgres extends CommentRepository{
    ...
    async addComment(newComment){
        ...
        const query = {
            ...
            values: [id, thread_id, content, del, date, owner]
        }
    ...
    async getThreadComments(id){
        const query = {
            text: `SELECT comments.id, comments.content, comments.date, comments.is_deleted, users.username FROM comments 
        ...
        return rows.map((item)=>new GetComment({...item}));
    }
}
